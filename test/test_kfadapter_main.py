...
class testKfadapterApi(TestCase):
    ...
    def test_get_all_runs(self, mock_get_kf_list_runs):
        ...
        self.assertEqual(response.content_type, "application/json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.get_data(), b'{"runid":{"experiment_id":"experiment-id1","pipeline_id":"pipeline-id1","pipeline_name":"pipeline-name1","run_description":"description","run_id":"runid","run_name":"run-name1","run_status":"status"}}\n')
